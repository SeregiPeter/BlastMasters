...
public class BiggerRangeBonusTest {

    Player player;
    BiggerRangeBonus biggerRangeBonus;
    ...
    @Test
    public void useTest() {
        int prevNumber = player.getBombRange();
        biggerRangeBonus.use();
        assertEquals(prevNumber + 1, player.getBombRange());
        prevNumber = player.getBombRange();
        biggerRangeBonus.use();
        biggerRangeBonus.use();
        assertEquals(prevNumber + 2, player.getBombRange());
