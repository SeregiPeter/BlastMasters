...
public class BoxBonusTest {
    ...
    @Test
    public void useTest() {
        assertEquals(0, player.getNumberOfPlaceableBoxes());

        boxBonus.use();
        assertEquals(3, player.getNumberOfPlaceableBoxes());

        boxBonus.use();
        assertEquals(6, player.getNumberOfPlaceableBoxes());
