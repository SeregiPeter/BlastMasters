...
public class immortalityBonusTest {

    Player player;
    ImmortalityBonus immortalityBonus;
    ...
    @Test
    public void useTest() {
        boolean immmortalPrevious = player.isImmortal();
        immortalityBonus.use();
        assertEquals(true, player.isImmortal());
